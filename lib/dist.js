...
async.autoInject({
  ...
  outputAsTurtle: ['baseAsNode', 'fullOutputStore', _.partial(rdflib.serialize, _, _, 'xxx', 'text/turtle')],
  ...
  outputAsRdfXml: ['baseAsNode', 'fullOutputStore', _.partial(rdflib.serialize, _, _, 'xxx', 'application/rdf+xml')],
